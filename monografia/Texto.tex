 ...
 \begin{folhadeaprovacao}
  ...
  \begin{center}
   ...
   %\assinatura{\textbf{\imprimircoorientadora} (Coorientadora)}
    \assinatura{Eng. Bruno Garkauskas Neto - (Banca Examinadora) }
   \assinatura{Dr. Henrique Resende Martins - (Banca Examinadora) }
   \assinatura{Dr. Pedro Bastos Costa - (Banca Examinadora)}
...
%  \item[h] Coeficiente convectivo [W/m²K]
...
%  \item[\textbf{Gregos}]
%  \item[$ \alpha $] Fração de vazio
%  \item[$ \mu $] Viscosidade dinâmica [N.s/m²]
%  \item[$ \rho $] Massa específica [kg/m³]
...
% \item[\textbf{Sobrescrito}]
 % \item[0]	Condição inicial
 % \item[f] 	Condição final

 % \item[\textbf{Constantes}]
 % \item[c]	Velocidade da luz no vácuo		$2,9979 \times 10^8\,\, \mathtt{m/s}$
 % \item[g]	Aceleração gravitacional		$9,7836\,\, \mathtt{m/s}^2$ 
 % \item[$\sigma$]	Constante de Stefan Boltzmann	$5,6703\times10^{-8}\,\, \mathtt{W/m}^2\mathtt{K}^4$
%\end{simbolos}
